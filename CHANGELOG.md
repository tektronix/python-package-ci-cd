...
- chore(python-deps): update dependency pylint to v4.0.8 for dev ([#1208](https://github.com/tektronix/python-package-ci-cd/pull/1208))
- feat(sbom-scan): enhance SBOM scanning with production dependency groups ([#1211](https://github.com/tektronix/python-package-ci-cd/pull/1211))
- chore(python-deps): update dependency dulwich to v1.2.14 in all dependant actions ([#1206](https://github.com/tektronix/python-package-ci-cd/pull/1206))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.24.2 in all dependant reusable workflows ([#1204](https://github.com/tektronix/python-package-ci-cd/pull/1204))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.24.1 in all dependant reusable workflows ([#1198](https://github.com/tektronix/python-package-ci-cd/pull/1198))
- chore(gh-actions-deps): update anchore/scan-action action to v7.4.1 in all dependant reusable workflows ([#1199](https://github.com/tektronix/python-package-ci-cd/pull/1199))
- chore(python-deps): update dependency platformdirs to v4.11.5 in all dependant actions ([#1200](https://github.com/tektronix/python-package-ci-cd/pull/1200))
- chore(python-deps): update dependency click to v8.5.0 in all dependant actions ([#1195](https://github.com/tektronix/python-package-ci-cd/pull/1195))
- chore(gh-actions-deps): update re-actors/alls-green action to v1.3.0 in all dependant reusable workflows ([#1186](https://github.com/tektronix/python-package-ci-cd/pull/1186))
- chore(gh-actions-deps): update re-actors/alls-green action to v1.3.0 in dev workflows ([#1187](https://github.com/tektronix/python-package-ci-cd/pull/1187))
- chore(python-deps): update dependency msgpack to v1.2.2 in all dependant actions ([#1197](https://github.com/tektronix/python-package-ci-cd/pull/1197))
- chore(pre-commit-deps): pre-commit autoupdate ([#1051](https://github.com/tektronix/python-package-ci-cd/pull/1051))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.9 in all dependant reusable workflows ([#1194](https://github.com/tektronix/python-package-ci-cd/pull/1194))
- chore(python-deps): update dependency pbs-installer to v2026.8.25 in all dependant actions ([#1193](https://github.com/tektronix/python-package-ci-cd/pull/1193))
- chore(python-deps): update dependency cryptography to v50.0.1 in all dependant actions ([#1192](https://github.com/tektronix/python-package-ci-cd/pull/1192))
- chore(python-deps): update dependency virtualenv to v21.7.5 in all dependant actions ([#1191](https://github.com/tektronix/python-package-ci-cd/pull/1191))
- chore(python-deps): update dependency platformdirs to v4.11.4 in all dependant actions ([#1190](https://github.com/tektronix/python-package-ci-cd/pull/1190))
- chore(python-deps): update dependency filelock to v3.32.4 in all dependant actions ([#1188](https://github.com/tektronix/python-package-ci-cd/pull/1188))
- chore(python-deps): update dependency dulwich to v1.2.13 in all dependant actions ([#1189](https://github.com/tektronix/python-package-ci-cd/pull/1189))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v24 in all dependant reusable workflows ([#1185](https://github.com/tektronix/python-package-ci-cd/pull/1185))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.8 in all dependant reusable workflows ([#1184](https://github.com/tektronix/python-package-ci-cd/pull/1184))
- chore(python-deps): update dependency pygments to v2.21.0 in all dependant actions ([#1181](https://github.com/tektronix/python-package-ci-cd/pull/1181))
- chore(python-deps): update dependency idna to v3.19 in all dependant actions ([#1182](https://github.com/tektronix/python-package-ci-cd/pull/1182))
- chore(python-deps): update dependency fastjsonschema to v2.22.2 in all dependant actions ([#1180](https://github.com/tektronix/python-package-ci-cd/pull/1180))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v23 in all dependant reusable workflows ([#1179](https://github.com/tektronix/python-package-ci-cd/pull/1179))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v22 in all dependant reusable workflows ([#1178](https://github.com/tektronix/python-package-ci-cd/pull/1178))
- chore(python-deps): update dependency charset-normalizer to v3.5.1 in all dependant actions ([#1177](https://github.com/tektronix/python-package-ci-cd/pull/1177))
- chore(python-deps): update dependency pbs-installer to v2026.8.14 in all dependant actions ([#1176](https://github.com/tektronix/python-package-ci-cd/pull/1176))
- chore(python-deps): update dependency filelock to v3.32.3 in all dependant actions ([#1174](https://github.com/tektronix/python-package-ci-cd/pull/1174))
- chore(python-deps): update dependency platformdirs to v4.11.3 in all dependant actions ([#1175](https://github.com/tektronix/python-package-ci-cd/pull/1175))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.7 in all dependant reusable workflows ([#1173](https://github.com/tektronix/python-package-ci-cd/pull/1173))
- chore(python-deps): update dependency typing-inspection to v0.4.4 in all dependant actions ([#1170](https://github.com/tektronix/python-package-ci-cd/pull/1170))
- chore(python-deps): update dependency pre-commit to v4.6.2 for actions/update_development_dependencies and dev ([#1168](https://github.com/tektronix/python-package-ci-cd/pull/1168))
- chore(python-deps): update dependency charset-normalizer to v3.5.0 in all dependant actions ([#1171](https://github.com/tektronix/python-package-ci-cd/pull/1171))
- chore(python-deps): update dependency virtualenv to v21.7.4 in all dependant actions ([#1169](https://github.com/tektronix/python-package-ci-cd/pull/1169))
- chore(python-deps): update dependency platformdirs to v4.11.2 in all dependant actions ([#1167](https://github.com/tektronix/python-package-ci-cd/pull/1167))
- chore(python-deps): update dependency typing-inspection to v0.4.3 in all dependant actions ([#1166](https://github.com/tektronix/python-package-ci-cd/pull/1166))
- chore(python-deps): update dependency pylint to v4.0.7 for dev ([#1165](https://github.com/tektronix/python-package-ci-cd/pull/1165))
- chore(python-deps): update dependency setuptools to v84 in all dependant actions ([#1164](https://github.com/tektronix/python-package-ci-cd/pull/1164))
- chore(python-deps): update dependency virtualenv to v21.7.3 in all dependant actions ([#1163](https://github.com/tektronix/python-package-ci-cd/pull/1163))
- chore(python-deps): update dependency platformdirs to v4.11.1 in all dependant actions ([#1161](https://github.com/tektronix/python-package-ci-cd/pull/1161))
- chore(python-deps): update dependency pbs-installer to v2026.8.7 in all dependant actions ([#1160](https://github.com/tektronix/python-package-ci-cd/pull/1160))
- chore(python-deps): update dependency virtualenv to v21.7.2 in all dependant actions ([#1162](https://github.com/tektronix/python-package-ci-cd/pull/1162))
- chore(gh-actions-deps): update actions/attest-build-provenance action to v4.2.2 in all dependant reusable workflows ([#1159](https://github.com/tektronix/python-package-ci-cd/pull/1159))
- chore(python-deps): update dependency soupsieve to v2.9.2 in all dependant actions ([#1158](https://github.com/tektronix/python-package-ci-cd/pull/1158))
- chore(python-deps): update dependency pbs-installer to v2026.8.5 in all dependant actions ([#1157](https://github.com/tektronix/python-package-ci-cd/pull/1157))
- chore(python-deps): update dependency packaging to v26.3 in all dependant actions ([#1155](https://github.com/tektronix/python-package-ci-cd/pull/1155))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.6 in all dependant reusable workflows ([#1154](https://github.com/tektronix/python-package-ci-cd/pull/1154))
- chore(python-deps): update dependency cffi to v2.1.1 in all dependant actions ([#1153](https://github.com/tektronix/python-package-ci-cd/pull/1153))
- chore(python-deps): update dependency typer to v0.27.1 in all dependant actions ([#1152](https://github.com/tektronix/python-package-ci-cd/pull/1152))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.5 in all dependant reusable workflows ([#1151](https://github.com/tektronix/python-package-ci-cd/pull/1151))
- chore(gh-actions-deps): update hynek/build-and-inspect-python-package action to v3 in all dependant reusable workflows ([#1148](https://github.com/tektronix/python-package-ci-cd/pull/1148))
- chore(python-deps): update dependency fastjsonschema to v2.22.1 in all dependant actions ([#1142](https://github.com/tektronix/python-package-ci-cd/pull/1142))
- chore(python-deps): update dependency virtualenv to v21.7.1 in all dependant actions ([#1150](https://github.com/tektronix/python-package-ci-cd/pull/1150))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.4 in all dependant reusable workflows ([#1149](https://github.com/tektronix/python-package-ci-cd/pull/1149))
- chore(python-deps): update dependency cryptography to v50 [security] ([#1147](https://github.com/tektronix/python-package-ci-cd/pull/1147))
- chore(python-deps): update dependency annotated-types to v0.8.0 in all dependant actions ([#1141](https://github.com/tektronix/python-package-ci-cd/pull/1141))
- chore(python-deps): update dependency filelock to v3.32.2 in all dependant actions ([#1146](https://github.com/tektronix/python-package-ci-cd/pull/1146))
- chore(gh-actions-deps): update pypa/gh-action-pypi-publish action to v1.14.2 in all dependant reusable workflows ([#1145](https://github.com/tektronix/python-package-ci-cd/pull/1145))
- chore(python-deps): update dependency pbs-installer to v2026.7.28 in all dependant actions ([#1143](https://github.com/tektronix/python-package-ci-cd/pull/1143))
- chore(gh-actions-deps): update actions/setup-python action to v7 in all dependant reusable workflows ([#1128](https://github.com/tektronix/python-package-ci-cd/pull/1128))
- chore(python-deps): update dependency filelock to v3.32.0 in all dependant actions ([#1132](https://github.com/tektronix/python-package-ci-cd/pull/1132))
- chore(python-deps): update dependency platformdirs to v4.11.0 in all dependant actions ([#1133](https://github.com/tektronix/python-package-ci-cd/pull/1133))
- chore(python-deps): update dependency virtualenv to v21.7.0 in all dependant actions ([#1134](https://github.com/tektronix/python-package-ci-cd/pull/1134))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.3 in all dependant reusable workflows ([#1139](https://github.com/tektronix/python-package-ci-cd/pull/1139))
- chore(python-deps): update dependency certifi to v2026.7.22 in all dependant actions ([#1138](https://github.com/tektronix/python-package-ci-cd/pull/1138))
- chore(python-deps): update dependency pre-commit to v4.6.1 for actions/update_development_dependencies and dev ([#1137](https://github.com/tektronix/python-package-ci-cd/pull/1137))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.2 in all dependant reusable workflows ([#1135](https://github.com/tektronix/python-package-ci-cd/pull/1135))
- chore(python-deps): update dependency soupsieve to v2.9.1 in all dependant actions ([#1136](https://github.com/tektronix/python-package-ci-cd/pull/1136))
- chore(python-deps): update dependency filelock to v3.31.2 in all dependant actions ([#1131](https://github.com/tektronix/python-package-ci-cd/pull/1131))
- chore(gh-actions-deps): update actions/checkout action to v7.0.1 in dev workflows ([#1130](https://github.com/tektronix/python-package-ci-cd/pull/1130))
- chore(gh-actions-deps): update actions/checkout action to v7.0.1 in all dependant reusable workflows ([#1129](https://github.com/tektronix/python-package-ci-cd/pull/1129))
- chore(python-deps): update dependency filelock to v3.31.1 in all dependant actions ([#1127](https://github.com/tektronix/python-package-ci-cd/pull/1127))
- chore(python-deps): update dependency soupsieve to v2.9 in all dependant actions ([#1124](https://github.com/tektronix/python-package-ci-cd/pull/1124))
- chore(python-deps): update dependency dulwich to v1.2.12 in all dependant actions ([#1126](https://github.com/tektronix/python-package-ci-cd/pull/1126))
- chore(gh-actions-deps): update pypa/gh-action-pypi-publish action to v1.14.1 in all dependant reusable workflows ([#1125](https://github.com/tektronix/python-package-ci-cd/pull/1125))
- chore(python-deps): update dependency pbs-installer to v2026.7.18 in all dependant actions ([#1123](https://github.com/tektronix/python-package-ci-cd/pull/1123))
- chore(python-deps): update dependency filelock to v3.31.0 in all dependant actions ([#1122](https://github.com/tektronix/python-package-ci-cd/pull/1122))
- chore(python-deps): update dependency platformdirs to v4.10.1 in all dependant actions ([#1121](https://github.com/tektronix/python-package-ci-cd/pull/1121))
- chore(python-deps): update dependency filelock to v3.30.3 in all dependant actions ([#1120](https://github.com/tektronix/python-package-ci-cd/pull/1120))
- chore(python-deps): update dependency typer to v0.27.0 in all dependant actions ([#1114](https://github.com/tektronix/python-package-ci-cd/pull/1114))
- chore(gh-actions-deps): update actions/setup-node action to v7 in all dependant reusable workflows ([#1112](https://github.com/tektronix/python-package-ci-cd/pull/1112))
- chore(python-deps): update dependency tomlkit to v0.15.1 in all dependant actions ([#1119](https://github.com/tektronix/python-package-ci-cd/pull/1119))
- chore(python-deps): update dependency dulwich to v1.2.11 in all dependant actions ([#1117](https://github.com/tektronix/python-package-ci-cd/pull/1117))
- chore(python-deps): update dependency filelock to v3.30.2 in all dependant actions ([#1118](https://github.com/tektronix/python-package-ci-cd/pull/1118))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.1 in all dependant reusable workflows ([#1116](https://github.com/tektronix/python-package-ci-cd/pull/1116))
- chore(python-deps): update dependency filelock to v3.30.1 in all dependant actions ([#1115](https://github.com/tektronix/python-package-ci-cd/pull/1115))
- chore(python-deps): update dependency jaraco-functools to v4.6.0 in all dependant actions ([#1111](https://github.com/tektronix/python-package-ci-cd/pull/1111))
- chore(python-deps): update dependency anyio to v4.14.2 in all dependant actions ([#1109](https://github.com/tektronix/python-package-ci-cd/pull/1109))
- chore(python-deps): update dependency virtualenv to v21.6.1 in all dependant actions ([#1108](https://github.com/tektronix/python-package-ci-cd/pull/1108))
- chore(python-deps): update dependency build to v1.5.1 in all dependant actions ([#1107](https://github.com/tektronix/python-package-ci-cd/pull/1107))
- chore(python-deps): update dependency setuptools to v83 in all dependant actions ([#1095](https://github.com/tektronix/python-package-ci-cd/pull/1095))
- chore(python-deps): update dependency virtualenv to v21.6.0 in all dependant actions ([#1102](https://github.com/tektronix/python-package-ci-cd/pull/1102))
- chore(python-deps): update dependency cffi to v2.1.0 in all dependant actions ([#1101](https://github.com/tektronix/python-package-ci-cd/pull/1101))
- chore(gh-actions-deps): update github/codeql-action action to v4.37.0 in all dependant reusable workflows ([#1105](https://github.com/tektronix/python-package-ci-cd/pull/1105))
- chore(python-deps): update dependency filelock to v3.29.7 in all dependant actions ([#1104](https://github.com/tektronix/python-package-ci-cd/pull/1104))
- chore(python-deps): update dependency charset-normalizer to v3.4.9 in all dependant actions ([#1103](https://github.com/tektronix/python-package-ci-cd/pull/1103))
- chore(python-deps): update dependency dulwich to v1.2.10 in all dependant actions ([#1099](https://github.com/tektronix/python-package-ci-cd/pull/1099))
- chore(python-deps): update dependency filelock to v3.29.6 in all dependant actions ([#1100](https://github.com/tektronix/python-package-ci-cd/pull/1100))
- chore(python-deps): update dependency dulwich to v1.2.9 in all dependant actions ([#1098](https://github.com/tektronix/python-package-ci-cd/pull/1098))
- chore(python-deps): update dependency virtualenv to v21.5.2 in all dependant actions ([#1097](https://github.com/tektronix/python-package-ci-cd/pull/1097))
- chore(python-deps): update dependency dulwich to v1.2.8 in all dependant actions ([#1096](https://github.com/tektronix/python-package-ci-cd/pull/1096))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v3.0.5 in all dependant reusable workflows ([#1094](https://github.com/tektronix/python-package-ci-cd/pull/1094))
- chore(python-deps): update dependency filelock to v3.29.5 in all dependant actions ([#1092](https://github.com/tektronix/python-package-ci-cd/pull/1092))
- chore(python-deps): update dependency pymdown-extensions to v11 for docs ([#1091](https://github.com/tektronix/python-package-ci-cd/pull/1091))
- chore(python-deps): update dependency typing-extensions to v4.16.0 in all dependant actions ([#1090](https://github.com/tektronix/python-package-ci-cd/pull/1090))
- chore(python-deps): update dependency cryptography to v49 in all dependant actions ([#1071](https://github.com/tektronix/python-package-ci-cd/pull/1071))
- chore(gh-actions-deps): update actions/checkout action to v7 in all dependant reusable workflows ([#1086](https://github.com/tektronix/python-package-ci-cd/pull/1086))
- chore(gh-actions-deps): update actions/checkout action to v7 in dev workflows ([#1088](https://github.com/tektronix/python-package-ci-cd/pull/1088))
- chore(gh-actions-deps): update github/codeql-action action to v4.36.3 in all dependant reusable workflows ([#1089](https://github.com/tektronix/python-package-ci-cd/pull/1089))
- chore(python-deps): update dependency anyio to v4.14.1 in all dependant actions ([#1082](https://github.com/tektronix/python-package-ci-cd/pull/1082))
- chore(gh-actions-deps): update actions/setup-python action to v6.3.0 in all dependant reusable workflows ([#1081](https://github.com/tektronix/python-package-ci-cd/pull/1081))
- chore(gh-actions-deps): update stefanzweifel/git-auto-commit-action action to v7.2.0 in all dependant reusable workflows ([#1083](https://github.com/tektronix/python-package-ci-cd/pull/1083))
- chore(python-deps): update dependency dulwich to v1.2.7 in all dependant actions ([#1087](https://github.com/tektronix/python-package-ci-cd/pull/1087))
- chore(gh-actions-deps): update actions/cache action to v6 in all dependant reusable workflows ([#1085](https://github.com/tektronix/python-package-ci-cd/pull/1085))
- chore(python-deps): update dependency certifi to v2026.6.17 in all dependant actions ([#1084](https://github.com/tektronix/python-package-ci-cd/pull/1084))
- chore(python-deps): update dependency virtualenv to v21.5.0 in all dependant actions ([#1073](https://github.com/tektronix/python-package-ci-cd/pull/1073))
- chore(python-deps): update dependency pylint to v4.0.6 for dev ([#1074](https://github.com/tektronix/python-package-ci-cd/pull/1074))
- chore(python-deps): update dependency pyright to v1.1.411 for dev ([#1078](https://github.com/tektronix/python-package-ci-cd/pull/1078))
- chore(python-deps): update dependency filelock to v3.29.4 in all dependant actions ([#1072](https://github.com/tektronix/python-package-ci-cd/pull/1072))
- chore(python-deps): update dependency typer to v0.26.8 in all dependant actions ([#1079](https://github.com/tektronix/python-package-ci-cd/pull/1079))
- chore(python-deps): update dependency click to v8.4.2 in all dependant actions ([#1077](https://github.com/tektronix/python-package-ci-cd/pull/1077))
- chore(python-deps): update dependency distlib to v0.4.3 in all dependant actions ([#1070](https://github.com/tektronix/python-package-ci-cd/pull/1070))
- chore(gh-actions-deps): update actions/attest-build-provenance action to v4.1.1 in all dependant reusable workflows ([#1076](https://github.com/tektronix/python-package-ci-cd/pull/1076))
- chore(python-deps): update dependency msgpack to v1.2.1 [security] ([#1075](https://github.com/tektronix/python-package-ci-cd/pull/1075))
...
- chore(python-deps): update dependency pydantic-core to v2.42.0 in all dependant actions ([#876](https://github.com/tektronix/python-package-ci-cd/pull/876))
- chore(python-deps): update dependency typer to v0.24.2 in all dependant actions ([#968](https://github.com/tektronix/python-package-ci-cd/pull/968))
- chore(python-deps): update dependency pre-commit to v4.6.0 for actions/update_development_dependencies and dev ([#965](https://github.com/tektronix/python-package-ci-cd/pull/965))
- chore(python-deps): update dependency idna to v3.13 in all dependant actions ([#969](https://github.com/tektronix/python-package-ci-cd/pull/969))
- chore(gh-actions-deps): update actions/setup-node action to v6.4.0 in all dependant reusable workflows ([#963](https://github.com/tektronix/python-package-ci-cd/pull/963))
- chore(python-deps): update dependency pyright to v1.1.409 for dev ([#974](https://github.com/tektronix/python-package-ci-cd/pull/974))
- chore(python-deps): update dependency click to v8.3.3 in all dependant actions ([#967](https://github.com/tektronix/python-package-ci-cd/pull/967))
- chore(python-deps): update dependency build to v1.4.4 in all dependant actions ([#971](https://github.com/tektronix/python-package-ci-cd/pull/971))
- fix: enhance PR number fetching logic with improved error handling and input validation ([#972](https://github.com/tektronix/python-package-ci-cd/pull/972))
- chore(python-deps): update dependency idna to v3.12 in all dependant actions ([#964](https://github.com/tektronix/python-package-ci-cd/pull/964))
- chore(python-deps): update dependency certifi to v2026.4.22 in all dependant actions ([#966](https://github.com/tektronix/python-package-ci-cd/pull/966))
- chore(python-deps): update dependency filelock to v3.29.0 in all dependant actions ([#962](https://github.com/tektronix/python-package-ci-cd/pull/962))
- chore(gh-actions-deps): update austenstone/job-summary action to v3 in dev workflows ([#960](https://github.com/tektronix/python-package-ci-cd/pull/960))
- chore(python-deps): update dependency filelock to v3.28.0 in all dependant actions ([#956](https://github.com/tektronix/python-package-ci-cd/pull/956))
- chore(python-deps): update dependency packaging to v26.1 in all dependant actions ([#957](https://github.com/tektronix/python-package-ci-cd/pull/957))
- chore(gh-actions-deps): update actions/cache action to v5.0.5 in all dependant reusable workflows ([#954](https://github.com/tektronix/python-package-ci-cd/pull/954))
- chore(gh-actions-deps): update github/codeql-action action to v4.35.2 in all dependant reusable workflows ([#958](https://github.com/tektronix/python-package-ci-cd/pull/958))
- chore(python-deps): update dependency identify to v2.6.19 in all dependant actions ([#961](https://github.com/tektronix/python-package-ci-cd/pull/961))
- chore(python-deps): update dependency virtualenv to v21.2.4 in all dependant actions ([#955](https://github.com/tektronix/python-package-ci-cd/pull/955))
- chore(pre-commit-deps): pre-commit autoupdate ([#932](https://github.com/tektronix/python-package-ci-cd/pull/932))
- chore(python-deps): update dependency poetry to v2.3.4 in all dependant actions ([#953](https://github.com/tektronix/python-package-ci-cd/pull/953))
- chore(python-deps): update dependency rich to v15 in all dependant actions ([#952](https://github.com/tektronix/python-package-ci-cd/pull/952))
- chore(python-deps): update dependency rich to v14.3.4 in all dependant actions ([#951](https://github.com/tektronix/python-package-ci-cd/pull/951))
- chore(gh-actions-deps): update actions/upload-artifact action to v7.0.1 in all dependant reusable workflows ([#948](https://github.com/tektronix/python-package-ci-cd/pull/948))
- chore(python-deps): update dependency build to v1.4.3 in all dependant actions ([#950](https://github.com/tektronix/python-package-ci-cd/pull/950))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v3.0.4 in all dependant reusable workflows ([#949](https://github.com/tektronix/python-package-ci-cd/pull/949))
- chore(gh-actions-deps): update actions/github-script action to v9 in dev workflows ([#947](https://github.com/tektronix/python-package-ci-cd/pull/947))
- chore(gh-actions-deps): update pypa/gh-action-pypi-publish action to v1.14.0 in all dependant reusable workflows ([#941](https://github.com/tektronix/python-package-ci-cd/pull/941))
- chore(python-deps): update dependency pbs-installer to v2026.4.7 in all dependant actions ([#944](https://github.com/tektronix/python-package-ci-cd/pull/944))
- chore(python-deps): update dependency virtualenv to v21.2.1 in all dependant actions ([#946](https://github.com/tektronix/python-package-ci-cd/pull/946))
- chore(python-deps): update dependency more-itertools to v11.0.2 in all dependant actions ([#945](https://github.com/tektronix/python-package-ci-cd/pull/945))
- chore(python-deps): update dependency platformdirs to v4.9.6 in all dependant actions ([#943](https://github.com/tektronix/python-package-ci-cd/pull/943))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v3.0.3 in all dependant reusable workflows ([#939](https://github.com/tektronix/python-package-ci-cd/pull/939))
- chore(python-deps): update dependency rapidfuzz to v3.14.5 in all dependant actions ([#940](https://github.com/tektronix/python-package-ci-cd/pull/940))
- chore(python-deps): update dependency cryptography to v46.0.7 [security] ([#938](https://github.com/tektronix/python-package-ci-cd/pull/938))
- chore(python-deps): update dependency click to v8.3.2 in all dependant actions ([#937](https://github.com/tektronix/python-package-ci-cd/pull/937))
- chore(gh-actions-deps): update andstor/file-existence-action action to v3.1.0 in all dependant reusable workflows ([#934](https://github.com/tektronix/python-package-ci-cd/pull/934))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v20 in all dependant reusable workflows ([#935](https://github.com/tektronix/python-package-ci-cd/pull/935))
- chore(python-deps): update dependency more-itertools to v11 in all dependant actions ([#936](https://github.com/tektronix/python-package-ci-cd/pull/936))
- chore(python-deps): update dependency charset-normalizer to v3.4.7 in all dependant actions ([#933](https://github.com/tektronix/python-package-ci-cd/pull/933))
- feat: make SSH signing optional for release workflow ([#931](https://github.com/tektronix/python-package-ci-cd/pull/931))

### Fixed

- Fixed the `fetch_pr_number` action to properly fetch PR numbers after recent GitHub API changes.
...
- chore(python-deps): update dependency requests to v2.33.1 in all dependant actions ([#930](https://github.com/tektronix/python-package-ci-cd/pull/930))
- chore(python-deps): update dependency attrs to v26 in all dependant actions ([#927](https://github.com/tektronix/python-package-ci-cd/pull/927))
- chore(gh-actions-deps): update codecov/codecov-action action to v6 in all dependant reusable workflows ([#925](https://github.com/tektronix/python-package-ci-cd/pull/925))
- chore(python-deps): update dependency anyio to v4.13.0 in all dependant actions ([#924](https://github.com/tektronix/python-package-ci-cd/pull/924))
- chore(gh-actions-deps): update nick-fields/retry action to v4 in all dependant reusable workflows ([#926](https://github.com/tektronix/python-package-ci-cd/pull/926))
- chore(python-deps): update dependency poetry to v2.3.3 [security] ([#923](https://github.com/tektronix/python-package-ci-cd/pull/923))
- chore(gh-actions-deps): update github/codeql-action action to v4.33.0 in all dependant reusable workflows ([#908](https://github.com/tektronix/python-package-ci-cd/pull/908))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v19 in all dependant reusable workflows ([#909](https://github.com/tektronix/python-package-ci-cd/pull/909))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v3 in all dependant reusable workflows ([#903](https://github.com/tektronix/python-package-ci-cd/pull/903))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.24.0 in all dependant reusable workflows ([#920](https://github.com/tektronix/python-package-ci-cd/pull/920))
- chore(python-deps): update dependency charset-normalizer to v3.4.6 in all dependant actions ([#906](https://github.com/tektronix/python-package-ci-cd/pull/906))
- chore(gh-actions-deps): update hynek/build-and-inspect-python-package action to v2.17.0 in all dependant reusable workflows ([#922](https://github.com/tektronix/python-package-ci-cd/pull/922))
- chore(gh-actions-deps): update anchore/scan-action action to v7.4.0 in all dependant reusable workflows ([#921](https://github.com/tektronix/python-package-ci-cd/pull/921))
- chore(python-deps): update dependency tomli to v2.4.1 for actions/create_unique_testpypi_version and docs ([#919](https://github.com/tektronix/python-package-ci-cd/pull/919))
- chore(python-deps): update dependency toml-sort to v0.24.4 for actions/update_development_dependencies ([#918](https://github.com/tektronix/python-package-ci-cd/pull/918))
- chore(python-deps): update dependency jaraco-context to v6.1.2 in all dependant actions ([#916](https://github.com/tektronix/python-package-ci-cd/pull/916))
- chore(python-deps): update dependency build to v1.4.2 in all dependant actions ([#915](https://github.com/tektronix/python-package-ci-cd/pull/915))
- chore(python-deps): update dependency pbs-installer to v2026.3.25 in all dependant actions ([#917](https://github.com/tektronix/python-package-ci-cd/pull/917))
- chore(python-deps): update dependency identify to v2.6.18 in all dependant actions ([#907](https://github.com/tektronix/python-package-ci-cd/pull/907))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.5.4 in all dependant reusable workflows ([#905](https://github.com/tektronix/python-package-ci-cd/pull/905))
- chore(gh-actions-deps): update actions/cache action to v5.0.4 in all dependant reusable workflows ([#904](https://github.com/tektronix/python-package-ci-cd/pull/904))
- chore(python-deps): update dependency filelock to v3.25.2 in all dependant actions ([#901](https://github.com/tektronix/python-package-ci-cd/pull/901))
- Dependency updates ([#914](https://github.com/tektronix/python-package-ci-cd/pull/914))
- chore(gh-actions-deps): update vimtor/action-zip action to v1.3 in all dependant reusable workflows ([#910](https://github.com/tektronix/python-package-ci-cd/pull/910))
- chore(gh-actions-deps): update actions/download-artifact action to v8.0.1 in all dependant reusable workflows ([#899](https://github.com/tektronix/python-package-ci-cd/pull/899))
- chore(python-deps): update dependency virtualenv to v21.2.0 in all dependant actions ([#897](https://github.com/tektronix/python-package-ci-cd/pull/897))
- chore(python-deps): update dependency pbs-installer to v2026.3.10 in all dependant actions ([#898](https://github.com/tektronix/python-package-ci-cd/pull/898))
- chore(python-deps): update dependency filelock to v3.25.1 in all dependant actions ([#895](https://github.com/tektronix/python-package-ci-cd/pull/895))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.23.1 in all dependant reusable workflows ([#894](https://github.com/tektronix/python-package-ci-cd/pull/894))
- chore(python-deps): update dependency setuptools to v82.0.1 in all dependant actions ([#896](https://github.com/tektronix/python-package-ci-cd/pull/896))
- chore(python-deps): update dependency jaraco-context to v6.1.1 in all dependant actions ([#893](https://github.com/tektronix/python-package-ci-cd/pull/893))
- chore(python-deps): update dependency charset-normalizer to v3.4.5 in all dependant actions ([#892](https://github.com/tektronix/python-package-ci-cd/pull/892))
- chore(python-deps): update dependency platformdirs to v4.9.4 in all dependant actions ([#891](https://github.com/tektronix/python-package-ci-cd/pull/891))
- chore(gh-actions-deps): update github/codeql-action action to v4.32.6 in all dependant reusable workflows ([#890](https://github.com/tektronix/python-package-ci-cd/pull/890))
- chore(pre-commit-deps): pre-commit autoupdate ([#889](https://github.com/tektronix/python-package-ci-cd/pull/889))
- chore(gh-actions-deps): update actions/dependency-review-action action to v4.9.0 in dev workflows ([#887](https://github.com/tektronix/python-package-ci-cd/pull/887))
- chore(gh-actions-deps): update crazy-max/ghaction-import-gpg action to v7 in all dependant reusable workflows ([#885](https://github.com/tektronix/python-package-ci-cd/pull/885))
- chore(gh-actions-deps): update actions/setup-node action to v6.3.0 in all dependant reusable workflows ([#886](https://github.com/tektronix/python-package-ci-cd/pull/886))
- chore(python-deps): update dependency pbs-installer to v2026.3.3 in all dependant actions ([#888](https://github.com/tektronix/python-package-ci-cd/pull/888))
- chore(gh-actions-deps): update github/codeql-action action to v4.32.5 in all dependant reusable workflows ([#884](https://github.com/tektronix/python-package-ci-cd/pull/884))
- chore(python-deps): update dependency identify to v2.6.17 in all dependant actions ([#883](https://github.com/tektronix/python-package-ci-cd/pull/883))
- chore(python-deps): update dependency filelock to v3.25.0 in all dependant actions ([#882](https://github.com/tektronix/python-package-ci-cd/pull/882))
- chore(python-deps): update dependency virtualenv to v21 in all dependant actions ([#880](https://github.com/tektronix/python-package-ci-cd/pull/880))
- chore(python-deps): update dependency virtualenv to v20.39.1 in all dependant actions ([#870](https://github.com/tektronix/python-package-ci-cd/pull/870))
- chore(python-deps): update dependency typer to v0.24.1 in all dependant actions ([#867](https://github.com/tektronix/python-package-ci-cd/pull/867))
- chore(python-deps): update dependency filelock to v3.21.2 in all dependant actions ([#861](https://github.com/tektronix/python-package-ci-cd/pull/861))
- chore(python-deps): update dependency platformdirs to v4.7.0 in all dependant actions ([#863](https://github.com/tektronix/python-package-ci-cd/pull/863))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.23.0 in all dependant reusable workflows ([#875](https://github.com/tektronix/python-package-ci-cd/pull/875))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v16 in all dependant reusable workflows ([#879](https://github.com/tektronix/python-package-ci-cd/pull/879))
- chore(gh-actions-deps): update actions/attest-build-provenance action to v4 in all dependant reusable workflows ([#881](https://github.com/tektronix/python-package-ci-cd/pull/881))
- chore(gh-actions-deps): update github artifact actions in all dependant reusable workflows ([#877](https://github.com/tektronix/python-package-ci-cd/pull/877))
...
- chore(gh-actions-deps): update pypa/gh-action-pypi-publish action to v1.13.0 in all dependant reusable workflows ([#668](https://github.com/tektronix/python-package-ci-cd/pull/668))
- chore(python-deps): update dependency cryptography to v46 in all dependant actions ([#667](https://github.com/tektronix/python-package-ci-cd/pull/667))
- chore(python-deps): update dependency pytest-cov to v7 for tests ([#665](https://github.com/tektronix/python-package-ci-cd/pull/665))
- chore(python-deps): update dependency cffi to v2 in all dependant actions ([#661](https://github.com/tektronix/python-package-ci-cd/pull/661))
- chore(python-deps): update dependency trove-classifiers to v2025.9.11.17 in all dependant actions ([#666](https://github.com/tektronix/python-package-ci-cd/pull/666))
- chore(python-deps): update dependency secretstorage to v3.4.0 in all dependant actions ([#660](https://github.com/tektronix/python-package-ci-cd/pull/660))
- chore(python-deps): update dependency pycparser to v2.23 in all dependant actions ([#659](https://github.com/tektronix/python-package-ci-cd/pull/659))
- chore(pre-commit-deps): pre-commit autoupdate ([#618](https://github.com/tektronix/python-package-ci-cd/pull/618))
- chore(gh-actions-deps): update github/codeql-action action to v3.30.3 in all dependant reusable workflows ([#664](https://github.com/tektronix/python-package-ci-cd/pull/664))
- chore(python-deps): update dependency yamlfix to v1.18.0 for actions/update_development_dependencies ([#654](https://github.com/tektronix/python-package-ci-cd/pull/654))
- chore(python-deps): update dependency toml-sort to v0.24.3 for actions/update_development_dependencies ([#662](https://github.com/tektronix/python-package-ci-cd/pull/662))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.5.1 in all dependant reusable workflows ([#652](https://github.com/tektronix/python-package-ci-cd/pull/652))
- chore(python-version): update python:3.13-slim docker digest to 58c30f5 in all dependant actions ([#651](https://github.com/tektronix/python-package-ci-cd/pull/651))
- chore(gh-actions-deps): update github/codeql-action action to v3.30.2 in all dependant reusable workflows ([#658](https://github.com/tektronix/python-package-ci-cd/pull/658))
- chore(python-deps): update dependency trove-classifiers to v2025.9.9.12 in all dependant actions ([#657](https://github.com/tektronix/python-package-ci-cd/pull/657))
- chore(python-deps): update dependency rapidfuzz to v3.14.1 in all dependant actions ([#656](https://github.com/tektronix/python-package-ci-cd/pull/656))
- chore(gh-actions-deps): update github/codeql-action action to v3.30.1 in all dependant reusable workflows ([#653](https://github.com/tektronix/python-package-ci-cd/pull/653))
- chore(python-deps): update dependency identify to v2.6.14 in all dependant actions ([#655](https://github.com/tektronix/python-package-ci-cd/pull/655))
- chore(gh-actions-deps): update actions/setup-python action to v6 in all dependant reusable workflows ([#648](https://github.com/tektronix/python-package-ci-cd/pull/648))
- chore(python-deps): update dependency pyright to v1.1.405 for dev ([#650](https://github.com/tektronix/python-package-ci-cd/pull/650))
- chore(python-version): update python:3.13-slim docker digest to 8ebd0ea in all dependant actions ([#649](https://github.com/tektronix/python-package-ci-cd/pull/649))
- chore(python-version): update python:3.13-slim docker digest to f71edd7 in all dependant actions ([#646](https://github.com/tektronix/python-package-ci-cd/pull/646))
- chore(gh-actions-deps): update actions/setup-node action to v5 in all dependant reusable workflows ([#644](https://github.com/tektronix/python-package-ci-cd/pull/644))
- chore(gh-actions-deps): update dev workflow dependencies ([#639](https://github.com/tektronix/python-package-ci-cd/pull/639))
- chore(python-deps): update dependency pypi-simple to v1.8.0 for actions/create_unique_testpypi_version and actions/update_development_dependencies ([#643](https://github.com/tektronix/python-package-ci-cd/pull/643))
- chore(python-deps): update dependency more-itertools to v10.8.0 in all dependant actions ([#642](https://github.com/tektronix/python-package-ci-cd/pull/642))
- chore(gh-actions-deps): update github/codeql-action action to v3.30.0 in all dependant reusable workflows ([#641](https://github.com/tektronix/python-package-ci-cd/pull/641))
- chore(python-deps): update dependency cryptography to v45.0.7 in all dependant actions ([#640](https://github.com/tektronix/python-package-ci-cd/pull/640))
- chore(gh-actions-deps): update actions/attest-build-provenance action to v3 in all dependant reusable workflows ([#638](https://github.com/tektronix/python-package-ci-cd/pull/638))
- chore(python-deps): update dependency rapidfuzz to v3.14.0 in all dependant actions ([#636](https://github.com/tektronix/python-package-ci-cd/pull/636))
- chore(python-deps): update dependency soupsieve to v2.8 in all dependant actions ([#637](https://github.com/tektronix/python-package-ci-cd/pull/637))
- chore(gh-actions-deps): update actions/dependency-review-action action to v4.7.3 in dev workflows ([#634](https://github.com/tektronix/python-package-ci-cd/pull/634))
- chore(python-deps): update dependency typing-extensions to v4.15.0 in all dependant actions ([#631](https://github.com/tektronix/python-package-ci-cd/pull/631))
- chore(python-deps): update dependency platformdirs to v4.4.0 in all dependant actions ([#633](https://github.com/tektronix/python-package-ci-cd/pull/633))
- chore(python-deps): update dependency trove-classifiers to v2025.8.26.11 in all dependant actions ([#632](https://github.com/tektronix/python-package-ci-cd/pull/632))
- chore(python-deps): update dependency beautifulsoup4 to v4.13.5 in all dependant actions ([#630](https://github.com/tektronix/python-package-ci-cd/pull/630))
- chore(gh-actions-deps): update github/codeql-action action to v3.29.11 in all dependant reusable workflows ([#629](https://github.com/tektronix/python-package-ci-cd/pull/629))
- chore(python-deps): update dependency pyright to v1.1.404 for dev ([#628](https://github.com/tektronix/python-package-ci-cd/pull/628))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.5.0 in all dependant reusable workflows ([#625](https://github.com/tektronix/python-package-ci-cd/pull/625))
- chore(python-deps): update dependency requests to v2.32.5 in all dependant actions ([#624](https://github.com/tektronix/python-package-ci-cd/pull/624))
- chore(gh-actions-deps): update actions/dependency-review-action action to v4.7.2 in dev workflows ([#623](https://github.com/tektronix/python-package-ci-cd/pull/623))
- chore(gh-actions-deps): update github/codeql-action action to v3.29.10 in all dependant reusable workflows ([#622](https://github.com/tektronix/python-package-ci-cd/pull/622))
- chore(python-deps): update dependency filelock to v3.19.1 in all dependant actions ([#621](https://github.com/tektronix/python-package-ci-cd/pull/621))
- chore(python-deps): update dependency fastjsonschema to v2.21.2 in all dependant actions ([#620](https://github.com/tektronix/python-package-ci-cd/pull/620))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.20.5 in all dependant reusable workflows ([#619](https://github.com/tektronix/python-package-ci-cd/pull/619))
...
- chore(pre-commit-deps): pre-commit autoupdate ([#545](https://github.com/tektronix/python-package-ci-cd/pull/545))
- chore(gh-actions-deps): update github/codeql-action action to v3.29.1 in all dependant reusable workflows ([#557](https://github.com/tektronix/python-package-ci-cd/pull/557))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v2.9.3 in all dependant reusable workflows ([#556](https://github.com/tektronix/python-package-ci-cd/pull/556))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v11 in all dependant reusable workflows ([#552](https://github.com/tektronix/python-package-ci-cd/pull/552))
- chore(gh-actions-deps): update hynek/build-and-inspect-python-package action to v2.13.0 in all dependant reusable workflows ([#554](https://github.com/tektronix/python-package-ci-cd/pull/554))
- chore(python-deps): update dependency certifi to v2025.6.15 in all dependant actions ([#553](https://github.com/tektronix/python-package-ci-cd/pull/553))
- chore(gh-actions-deps): update anchore/scan-action action to v6.3.0 in all dependant reusable workflows ([#550](https://github.com/tektronix/python-package-ci-cd/pull/550))
- chore(python-deps): update dependency urllib3 to v2.5.0 [security] ([#551](https://github.com/tektronix/python-package-ci-cd/pull/551))
- chore(python-deps): update dependency msgpack to v1.1.1 in all dependant actions ([#549](https://github.com/tektronix/python-package-ci-cd/pull/549))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.20.1 in all dependant reusable workflows ([#548](https://github.com/tektronix/python-package-ci-cd/pull/548))
- chore(gh-actions-deps): update actions/attest-build-provenance action to v2.4.0 in all dependant reusable workflows ([#546](https://github.com/tektronix/python-package-ci-cd/pull/546))
- chore(gh-actions-deps): update github/codeql-action action to v3.29.0 in all dependant reusable workflows ([#547](https://github.com/tektronix/python-package-ci-cd/pull/547))
- chore(gh-actions-deps): update stefanzweifel/git-auto-commit-action action to v6 in all dependant reusable workflows ([#543](https://github.com/tektronix/python-package-ci-cd/pull/543))
- chore(python-deps): update dependency pyright to v1.1.402 for dev ([#544](https://github.com/tektronix/python-package-ci-cd/pull/544))
- chore(python-deps): update dependency cryptography to v45.0.4 in all dependant actions ([#542](https://github.com/tektronix/python-package-ci-cd/pull/542))
- chore(python-version): update python:3.13-alpine docker digest to 9b4929a in all dependant actions ([#541](https://github.com/tektronix/python-package-ci-cd/pull/541))
- chore(python-version): update python:3.13-alpine docker digest to bd8f7ae in all dependant actions ([#540](https://github.com/tektronix/python-package-ci-cd/pull/540))
- chore(python-deps): update dependency tomlkit to v0.13.3 in all dependant actions ([#539](https://github.com/tektronix/python-package-ci-cd/pull/539))
- chore(python-deps): update dependency typing-extensions to v4.14.0 in all dependant actions ([#535](https://github.com/tektronix/python-package-ci-cd/pull/535))
- chore(python-deps): update dependency requests to v2.32.4 [security] ([#538](https://github.com/tektronix/python-package-ci-cd/pull/538))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.19 in all dependant reusable workflows ([#536](https://github.com/tektronix/python-package-ci-cd/pull/536))
- chore(python-version): update python:3.13-alpine docker digest to b4d2993 in all dependant actions ([#534](https://github.com/tektronix/python-package-ci-cd/pull/534))
...
- chore(pre-commit-deps): pre-commit autoupdate ([#524](https://github.com/tektronix/python-package-ci-cd/pull/524))
- chore(python-deps): update dependency setuptools to v80.9.0 in all dependant actions ([#531](https://github.com/tektronix/python-package-ci-cd/pull/531))
- chore(python-version): update python:3.13-alpine docker digest to a94caf6 in all dependant actions ([#530](https://github.com/tektronix/python-package-ci-cd/pull/530))
- chore(python-version): update python:3.13-alpine docker digest to a9bceef in all dependant actions ([#529](https://github.com/tektronix/python-package-ci-cd/pull/529))
- chore(python-deps): update dependency cryptography to v45.0.3 in all dependant actions ([#527](https://github.com/tektronix/python-package-ci-cd/pull/527))
- chore(python-deps): update dependency identify to v2.6.12 in all dependant actions ([#526](https://github.com/tektronix/python-package-ci-cd/pull/526))
- chore(python-deps): update dependency setuptools to v80.8.0 in all dependant actions ([#521](https://github.com/tektronix/python-package-ci-cd/pull/521))
- chore(python-deps): update dependency click to v8.2.1 in all dependant actions ([#522](https://github.com/tektronix/python-package-ci-cd/pull/522))
- chore(python-deps): update dependency pyright to v1.1.401 for dev ([#523](https://github.com/tektronix/python-package-ci-cd/pull/523))
- docs: Update links to new URLs to make builds pass ([#525](https://github.com/tektronix/python-package-ci-cd/pull/525))
- chore(python-deps): update dependency cryptography to v45 in all dependant actions ([#520](https://github.com/tektronix/python-package-ci-cd/pull/520))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.4.3 in all dependant reusable workflows ([#519](https://github.com/tektronix/python-package-ci-cd/pull/519))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.18 in all dependant reusable workflows ([#518](https://github.com/tektronix/python-package-ci-cd/pull/518))
- chore(python-deps): update dependency setuptools to v80.7.1 in all dependant actions ([#517](https://github.com/tektronix/python-package-ci-cd/pull/517))
- chore(python-deps): update dependency setuptools to v80.6.0 in all dependant actions ([#516](https://github.com/tektronix/python-package-ci-cd/pull/516))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.20.0 in all dependant reusable workflows ([#515](https://github.com/tektronix/python-package-ci-cd/pull/515))
- chore(gh-actions-deps): update actions/dependency-review-action action to v4.7.1 in dev workflows ([#513](https://github.com/tektronix/python-package-ci-cd/pull/513))
- chore(python-deps): update dependency click to v8.2.0 in all dependant actions ([#512](https://github.com/tektronix/python-package-ci-cd/pull/512))
- chore(python-deps): update dependency setuptools to v80.4.0 in all dependant actions ([#511](https://github.com/tektronix/python-package-ci-cd/pull/511))
- chore(python-deps): update dependency trove-classifiers to v2025.5.9.12 in all dependant actions ([#510](https://github.com/tektronix/python-package-ci-cd/pull/510))
- chore(gh-actions-deps): update actions/dependency-review-action action to v4.7.0 in dev workflows ([#509](https://github.com/tektronix/python-package-ci-cd/pull/509))
- chore(python-deps): update dependency virtualenv to v20.31.2 in all dependant actions ([#508](https://github.com/tektronix/python-package-ci-cd/pull/508))
- chore(python-deps): update dependency trove-classifiers to v2025.5.8.15 in all dependant actions ([#507](https://github.com/tektronix/python-package-ci-cd/pull/507))
- chore(python-deps): update dependency platformdirs to v4.3.8 in all dependant actions ([#506](https://github.com/tektronix/python-package-ci-cd/pull/506))
- chore(python-deps): update dependency trove-classifiers to v2025.5.7.19 in all dependant actions ([#505](https://github.com/tektronix/python-package-ci-cd/pull/505))
- chore(python-version): update python:3.13-alpine docker digest to 452682e in all dependant actions ([#503](https://github.com/tektronix/python-package-ci-cd/pull/503))
- chore(python-version): update python:3.13-alpine docker digest to f80206d in all dependant actions ([#501](https://github.com/tektronix/python-package-ci-cd/pull/501))
- chore(python-version): update python:3.13-alpine docker digest to f50e1ca in all dependant actions ([#500](https://github.com/tektronix/python-package-ci-cd/pull/500))
- chore(python-deps): update dependency setuptools to v80.3.1 in all dependant actions ([#498](https://github.com/tektronix/python-package-ci-cd/pull/498))
- chore(python-deps): update dependency charset-normalizer to v3.4.2 in all dependant actions ([#497](https://github.com/tektronix/python-package-ci-cd/pull/497))
- chore(python-deps): update dependency virtualenv to v20.31.1 in all dependant actions ([#496](https://github.com/tektronix/python-package-ci-cd/pull/496))
- chore(python-deps): update dependency setuptools to v80.1.0 in all dependant actions ([#494](https://github.com/tektronix/python-package-ci-cd/pull/494))
- chore(python-deps): update dependency cachecontrol to v0.14.3 in all dependant actions ([#492](https://github.com/tektronix/python-package-ci-cd/pull/492))
- chore(python-deps): update dependency pylint to v3.3.7 for dev ([#493](https://github.com/tektronix/python-package-ci-cd/pull/493))
...
- chore(gh-actions-deps): update actions/attest-build-provenance action to v2.3.0 in all dependant reusable workflows ([#490](https://github.com/tektronix/python-package-ci-cd/pull/490))
- chore(gh-actions-deps): update anchore/scan-action action to v6.2.0 in all dependant reusable workflows ([#491](https://github.com/tektronix/python-package-ci-cd/pull/491))
- chore(python-deps): update dependency cryptography to v44.0.3 in all dependant actions ([#489](https://github.com/tektronix/python-package-ci-cd/pull/489))
- chore(python-deps): update dependency setuptools to v80.0.1 in all dependant actions ([#488](https://github.com/tektronix/python-package-ci-cd/pull/488))
- chore(python-deps): update dependency trove-classifiers to v2025.5.1.12 in all dependant actions ([#487](https://github.com/tektronix/python-package-ci-cd/pull/487))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.17 in all dependant reusable workflows ([#486](https://github.com/tektronix/python-package-ci-cd/pull/486))
- chore(python-deps): update dependency setuptools to v80 in all dependant actions ([#485](https://github.com/tektronix/python-package-ci-cd/pull/485))
- chore(gh-actions-deps): update actions/download-artifact action to v4.3.0 in all dependant reusable workflows ([#480](https://github.com/tektronix/python-package-ci-cd/pull/480))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.19.0 in all dependant reusable workflows ([#481](https://github.com/tektronix/python-package-ci-cd/pull/481))
- test: Update test to properly check for expected pull request number ([#484](https://github.com/tektronix/python-package-ci-cd/pull/484))
- chore(python-deps): update dependency pyright to v1.1.400 for dev ([#479](https://github.com/tektronix/python-package-ci-cd/pull/479))
- chore(python-deps): update dependency certifi to v2025.4.26 in all dependant actions ([#482](https://github.com/tektronix/python-package-ci-cd/pull/482))
- chore(gh-actions-deps): update actions/setup-python action to v5.6.0 in all dependant reusable workflows ([#478](https://github.com/tektronix/python-package-ci-cd/pull/478))
- chore(python-deps): update dependency setuptools to v79.0.1 in all dependant actions ([#477](https://github.com/tektronix/python-package-ci-cd/pull/477))
- chore(pre-commit-deps): pre-commit autoupdate ([#453](https://github.com/tektronix/python-package-ci-cd/pull/453))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.16 in all dependant reusable workflows ([#475](https://github.com/tektronix/python-package-ci-cd/pull/475))
- chore(python-deps): update dependency more-itertools to v10.7.0 in all dependant actions ([#474](https://github.com/tektronix/python-package-ci-cd/pull/474))
- chore(python-deps): update dependency soupsieve to v2.7 in all dependant actions ([#473](https://github.com/tektronix/python-package-ci-cd/pull/473))
- chore(python-deps): update dependency setuptools to v79 in all dependant actions ([#472](https://github.com/tektronix/python-package-ci-cd/pull/472))
- chore(python-deps): update dependency packaging to v25 in all dependant actions ([#470](https://github.com/tektronix/python-package-ci-cd/pull/470))
- chore(gh-actions-deps): update stefanzweifel/git-auto-commit-action action to v5.2.0 in all dependant reusable workflows ([#468](https://github.com/tektronix/python-package-ci-cd/pull/468))
- chore(python-deps): update dependency setuptools to v78.1.1 in all dependant actions ([#471](https://github.com/tektronix/python-package-ci-cd/pull/471))
- chore(python-deps): update dependency identify to v2.6.10 in all dependant actions ([#469](https://github.com/tektronix/python-package-ci-cd/pull/469))
- chore(python-deps): update dependency beautifulsoup4 to v4.13.4 in all dependant actions ([#466](https://github.com/tektronix/python-package-ci-cd/pull/466))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.4.2 in all dependant reusable workflows ([#465](https://github.com/tektronix/python-package-ci-cd/pull/465))
- chore(python-deps): update dependency urllib3 to v2.4.0 in all dependant actions ([#463](https://github.com/tektronix/python-package-ci-cd/pull/463))
- chore(python-deps): update dependency trove-classifiers to v2025.4.11.15 in all dependant actions ([#464](https://github.com/tektronix/python-package-ci-cd/pull/464))
- chore(python-deps): update dependency typing-extensions to v4.13.2 in all dependant actions ([#462](https://github.com/tektronix/python-package-ci-cd/pull/462))
- chore(gh-actions-deps): update actions/setup-node action to v4.4.0 in all dependant reusable workflows ([#460](https://github.com/tektronix/python-package-ci-cd/pull/460))
- chore(python-deps): update dependency pyright to v1.1.399 for dev ([#459](https://github.com/tektronix/python-package-ci-cd/pull/459))
- Increase Codefactor score ([#458](https://github.com/tektronix/python-package-ci-cd/pull/458))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v2.9.2 in all dependant reusable workflows ([#457](https://github.com/tektronix/python-package-ci-cd/pull/457))
- chore(python-version): update python:3.13-alpine docker digest to 18159b2 in all dependant actions ([#456](https://github.com/tektronix/python-package-ci-cd/pull/456))
- chore(python-version): update python:3.13-alpine docker digest to 5b55b49 in all dependant actions ([#455](https://github.com/tektronix/python-package-ci-cd/pull/455))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.15 in all dependant reusable workflows ([#454](https://github.com/tektronix/python-package-ci-cd/pull/454))
- chore(python-deps): update dependency virtualenv to v20.30.0 in all dependant actions ([#451](https://github.com/tektronix/python-package-ci-cd/pull/451))
- chore(python-deps): update dependency rapidfuzz to v3.13.0 in all dependant actions ([#450](https://github.com/tektronix/python-package-ci-cd/pull/450))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.14 in all dependant reusable workflows ([#452](https://github.com/tektronix/python-package-ci-cd/pull/452))
- chore(gh-actions-deps): update actions/dependency-review-action action to v4.6.0 in dev workflows ([#449](https://github.com/tektronix/python-package-ci-cd/pull/449))
- chore(python-deps): update dependency typing-extensions to v4.13.1 in all dependant actions ([#448](https://github.com/tektronix/python-package-ci-cd/pull/448))
- chore(gh-actions-deps): update crazy-max/ghaction-import-gpg action to v6.3.0 in all dependant reusable workflows ([#447](https://github.com/tektronix/python-package-ci-cd/pull/447))
...
- chore(pre-commit-deps): pre-commit autoupdate ([#308](https://github.com/tektronix/python-package-ci-cd/pull/308))
- chore(python-deps): update dependency beautifulsoup4 to v4.13.1 in all dependant actions ([#358](https://github.com/tektronix/python-package-ci-cd/pull/358))
- chore(gh-actions-deps): update actions/setup-python action to v5.4.0 in all dependant reusable workflows ([#357](https://github.com/tektronix/python-package-ci-cd/pull/357))
- chore(python-deps): update dependency rapidfuzz to v3.12.1 in all dependant actions ([#356](https://github.com/tektronix/python-package-ci-cd/pull/356))
- chore(python-deps): update dependency attrs to v25 in all dependant actions ([#352](https://github.com/tektronix/python-package-ci-cd/pull/352))
- chore(python-deps): update dependency pyright to v1.1.393 for dev ([#351](https://github.com/tektronix/python-package-ci-cd/pull/351))
- chore(python-deps): update dependency pylint to v3.3.4 for dev ([#350](https://github.com/tektronix/python-package-ci-cd/pull/350))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.8 in all dependant reusable workflows ([#349](https://github.com/tektronix/python-package-ci-cd/pull/349))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.3.0 in all dependant reusable workflows ([#346](https://github.com/tektronix/python-package-ci-cd/pull/346))
- chore(gh-actions-deps): update anchore/scan-action action to v6.1.0 in all dependant reusable workflows ([#345](https://github.com/tektronix/python-package-ci-cd/pull/345))
- chore(gh-actions-deps): update anchore/sbom-action action to v0.18.0 in all dependant reusable workflows ([#344](https://github.com/tektronix/python-package-ci-cd/pull/344))
- chore(python-deps): update dependency pydantic to v2.10.6 in all dependant actions ([#347](https://github.com/tektronix/python-package-ci-cd/pull/347))
- chore(gh-actions-deps): update hynek/build-and-inspect-python-package action to v2.12.0 in all dependant reusable workflows ([#340](https://github.com/tektronix/python-package-ci-cd/pull/340))
- chore(gh-actions-deps): update actions/setup-node action to v4.2.0 in all dependant reusable workflows ([#342](https://github.com/tektronix/python-package-ci-cd/pull/342))
- chore(gh-actions-deps): update dawidd6/action-download-artifact action to v8 in all dependant reusable workflows ([#341](https://github.com/tektronix/python-package-ci-cd/pull/341))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.5 in all dependant reusable workflows ([#339](https://github.com/tektronix/python-package-ci-cd/pull/339))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.4 in all dependant reusable workflows ([#338](https://github.com/tektronix/python-package-ci-cd/pull/338))
- chore(gh-actions-deps): update codecov/codecov-action action to v5.2.0 in all dependant reusable workflows ([#337](https://github.com/tektronix/python-package-ci-cd/pull/337))
- chore(gh-actions-deps): update actions/attest-build-provenance action to v2.2.0 in all dependant reusable workflows ([#336](https://github.com/tektronix/python-package-ci-cd/pull/336))
- chore(python-deps): update dependency pre-commit to v4.1.0 for actions/update_development_dependencies and dev ([#335](https://github.com/tektronix/python-package-ci-cd/pull/335))
- chore(python-deps): update dependency filelock to v3.17.0 in all dependant actions ([#334](https://github.com/tektronix/python-package-ci-cd/pull/334))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.2 in all dependant reusable workflows ([#333](https://github.com/tektronix/python-package-ci-cd/pull/333))
- chore(python-deps): update dependency identify to v2.6.6 in all dependant actions ([#332](https://github.com/tektronix/python-package-ci-cd/pull/332))
- chore(python-deps): update dependency virtualenv to v20.29.1 in all dependant actions ([#331](https://github.com/tektronix/python-package-ci-cd/pull/331))
- chore(python-deps): update dependency virtualenv to v20.29.0 in all dependant actions ([#329](https://github.com/tektronix/python-package-ci-cd/pull/329))
- chore(python-deps): update dependency pyright to v1.1.392.post0 for dev ([#328](https://github.com/tektronix/python-package-ci-cd/pull/328))
- chore(python-deps): update dependency tomli-w to v1.2.0 for actions/create_unique_testpypi_version ([#327](https://github.com/tektronix/python-package-ci-cd/pull/327))
- chore(python-deps): update dependency pyright to v1.1.392 for dev ([#326](https://github.com/tektronix/python-package-ci-cd/pull/326))
- chore(python-deps): update dependency more-itertools to v10.6.0 in all dependant actions ([#325](https://github.com/tektronix/python-package-ci-cd/pull/325))
- chore(gh-actions-deps): update marocchino/sticky-pull-request-comment action to v2.9.1 in all dependant reusable workflows ([#324](https://github.com/tektronix/python-package-ci-cd/pull/324))
- chore(python-deps): update dependency trove-classifiers to v2025.1.15.22 in all dependant actions ([#321](https://github.com/tektronix/python-package-ci-cd/pull/321))
- chore(gh-actions-deps): update stefanzweifel/git-auto-commit-action action to v5.1.0 in all dependant reusable workflows ([#319](https://github.com/tektronix/python-package-ci-cd/pull/319))
- chore(gh-actions-deps): update github/codeql-action action to v3.28.1 in all dependant reusable workflows ([#317](https://github.com/tektronix/python-package-ci-cd/pull/317))
- chore(python-deps): update dependency trove-classifiers to v2025.1.10.15 in all dependant actions ([#318](https://github.com/tektronix/python-package-ci-cd/pull/318))
- chore(gh-actions-deps): update actions/upload-artifact action to v4.6.0 in all dependant reusable workflows ([#316](https://github.com/tektronix/python-package-ci-cd/pull/316))
- chore(python-deps): update dependency pydantic to v2.10.5 in all dependant actions ([#315](https://github.com/tektronix/python-package-ci-cd/pull/315))
- chore(python-deps): update dependency setuptools to v75.8.0 in all dependant actions ([#313](https://github.com/tektronix/python-package-ci-cd/pull/313))
- chore(python-deps): update dependency trove-classifiers to v2025 in all dependant actions ([#311](https://github.com/tektronix/python-package-ci-cd/pull/311))
- chore(python-deps): update dependency cachecontrol to v0.14.2 in all dependant actions ([#312](https://github.com/tektronix/python-package-ci-cd/pull/312))
- chore(python-deps): update dependency setuptools to v75.7.0 in all dependant actions ([#310](https://github.com/tektronix/python-package-ci-cd/pull/310))
- chore(python-deps): update dependency xattr to v1.1.4 in all dependant actions ([#309](https://github.com/tektronix/python-package-ci-cd/pull/309))
- chore(python-deps): update dependency virtualenv to v20.28.1 in all dependant actions ([#304](https://github.com/tektronix/python-package-ci-cd/pull/304))
- chore(python-deps): update dependency identify to v2.6.5 in all dependant actions ([#305](https://github.com/tektronix/python-package-ci-cd/pull/305))
